        ...
        <div className='space-y-6'>
            <div className='flex items-center justify-between '>
                <div>
                    ...
                    <p className='text-sm text-gray-500'>Add your education experience</p>
                </div>
                <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-purple-200 transition-colors disabled:opacity-50'>
                    ...
                    {data.map((education, index) => (
                        <div key={index} className='p-4 border-gray-200 rounded-lg spacee-y-3'>
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                <input value={education.graduation_date || ""} onChange={(e) => updateEducation(index, "graduation_date", e.target.value)} type="text" className='px-3 py-2 text-sm' />
