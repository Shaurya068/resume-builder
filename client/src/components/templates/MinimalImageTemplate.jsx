...
const MinimalImageTemplate = ({ data, accentColor }) => {
    ...
    // create/revoke object URL whenever data.image (file) changes
    useEffect(() => {
        // if data.image is a File object, create preview
        if (data?.personal_info?.image && typeof data.personal_info.image !== 'string') {
            ...
            // if image is a string, show that directly
            setPreviewUrl(null)
        }
        ...
        <div className="max-w-5xl mx-auto bg-white text-zinc-800">
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    {/* Image */}
                    {(previewUrl || (data.personal_info?.image && typeof data.personal_info.image === 'string')) ? (
                        <div className="mb-6">
                            <img src={previewUrl || data.personal_info.image} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: accentColor + '70' }} />
                        </div>
                    ) : null}
                </div>
