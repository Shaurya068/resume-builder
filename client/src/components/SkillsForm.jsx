    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
                <p className='text-sm text-blue-800'><strong>Tip:</strong>Include only relevant technical and soft skills that directly align with the role you’re applying for, and be ready to demonstrate them with examples.</p>
            </div>
        </div>
    )
}
